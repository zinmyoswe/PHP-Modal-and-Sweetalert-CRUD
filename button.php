<!-- Delete -->
                	<!-- Modal -->
<div class="modal fade" id="del<?php echo $row['userid']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<!-- Edit -->
                	...
                	<!-- Modal -->
<div class="modal fade" id="edit<?php echo $row['userid']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
